...
CREATE TABLE IF NOT EXISTS ${ods_schema_name}.tbl_catalogs_delta_tmp
(
    dws_job                     string,
    dws_act                     string,
    nk                          string,
...
INSERT INTO TABLE ${ods_schema_name}.tbl_catalogs_delta_tmp partition (`date`)
(dws_job, dws_act,nk, dws_uniact, id, creation_date, last_modified_date,
removal_date, removed, title, case_id, num_, idholder, shorttitle,
holiday_startdate, holiday_parentops, holiday_datenotify, holiday_enddate,
cimodel_vendor, route_templatedescr, route_cancheckci, workinghours_parentholiday,
workinghours_parentops, workinghours_endworktimeh, workinghours_beginworktimem,
...
FROM ${ods_schema_name}.tbl_catalogs_delta;
