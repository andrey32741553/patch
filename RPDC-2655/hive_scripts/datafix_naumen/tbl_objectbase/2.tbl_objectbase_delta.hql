...
(dws_job, dws_act, nk, dws_uniact, id, creation_date, last_modified_date, removal_date,
 removed, archqueue, author_id, case_id, cimodel, configitem_activeaudit,
...
SELECT dws_job,
       ...
       insert_date,
       `date`
FROM ${ods_schema_name}.tbl_objectbase_delta_tmp;

DROP TABLE IF EXISTS ${ods_schema_name}.tbl_objectbase_delta_tmp;