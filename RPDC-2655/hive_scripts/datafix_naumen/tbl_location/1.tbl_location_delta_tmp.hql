...
CREATE TABLE IF NOT EXISTS ${ods_schema_name}.tbl_location_delta_tmp
(
    dws_job                   string,
    dws_act                   string,
    nk                        string,
...
INSERT INTO TABLE ${ods_schema_name}.tbl_location_delta_tmp partition (`date`)
(dws_job,
 dws_act,
 nk,
 dws_uniact,
...
FROM ${ods_schema_name}.tbl_location_delta;
